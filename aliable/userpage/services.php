...
<body class="">
  ...
  <header class="container-fluid header py-5">
      ...
      <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="container">
          <div class="row">
          <h2 class="header-heading display-3 fw-bold">Our Services</h2>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="row">
          <div class=" col-xl-2 col-lg-2 col-md-1 "></div>
            <div class="col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12">
                <h2 class="display-5  what ">Solutions for every business need.</h2>
            </div>
          <div class="col-xl-2 col-lg-2 col-md-1 "></div>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-1 col-lg-1 col-md-1 col-sm-0 col-0"></div>
        <div class="col-xl-10 col-md-10 col-lg-10 col-sm-12 col-12">
          <div class="row ">
            <!-- first Service -->
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 px-4 my-2 ">
              <div class="row">
              ...
              <div class="row my-3 service-heading-div">
                <h4 class="fs-4 ps-0 service-heading">What are my options and the cost to Exercise?</h4>
              </div>
              <div class="row my-3">
    ...
    <button class="btn services-button  px-5 py-3 mt-4  ">
        <span class="mx-5 px-xl-4 px-lg-4 px-md-4 px-md-3 px-sm-2 px-2 services-button-text">Lets Start</span>
      </button> 
    </div>
    </div>
  ...
  <div class="container-fluid service-card-div">
      <div class="row">
          <div class=" col-xl-1 col-lg-1 col-md-1 col-sm-2 col-1 "></div>

          <div class="col-xl-10 col-lg-10 col-md-10 col-sm-8 col-10">
              <div class="container-fluid all-servise px-4">
                  <div class="row">

                  <div class="col-sm-12 col-md-6 col-lg-4  ">
                              <div class="card my-card p-4 my-4 ">
                                  <div class="row">
                                      <div class="col-4  ">
                                          <img src="../images/SERVICE-1.svg" alt="">
                                      </div>
                                      <div class="col-8   d-flex justify-content-center">
                                          <h3 class="card-service-label mt-4 ">Amazon PPC</h3>
                                      </div>
                                  </div>
                                  
                                  <div class="row mb-3 mt-4 ">
                                      <hr class="service-hr  w-100">
                                  </div>
                                      <p class="card-service-text fs-6">You may spend money on ads without understanding whether your ads are effective or not. Use our data-driven PPC services to boost your Amazon sales!</p>
                                  <!-- <div class="button-div ms-auto me-auto">
                                      <button class="card-service-button btn btn-primary">Buy Now</button>
                                  </div> -->
                                  <div class="row">

                                  <a href="//api.whatsapp.com/send?phone=923138275277&text=Mujay apki services chahiyay 28" title="Share on whatsapp">
                                      <button class="card-service-button btn w-100 ">Buy Now</button>
                                  </a>
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-4  ">
                              <div class="card my-card p-4 my-4 ">
                                  ...
                                  <a href="//api.whatsapp.com/send?phone=923138275277&text=Button no 8 pressed" title="Share on whatsapp">
                                      <button class="card-service-button btn w-100 ">Buy Now</button>
                                  </a>
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-4  ">
                              <div class="card my-card p-4 my-4 ">
                                  ...
                                  <a href="//api.whatsapp.com/send?phone=923138275277&text=Button no 9 pressed" title="Share on whatsapp">
                                      <button class="card-service-button btn w-100 ">Buy Now</button>
                                  </a>
    ...
    <section class="acute-developer-section mt-5">
                ...
                <div class="container-fluid ">
                  <div class="row margin-md"></div>
                    <div class="row">
                      <div class=" col-xl-2 col-lg-2 col-md-1 "></div>
                        <div class="col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12">
                            <h2 class="display-5  what digital-marketing-title  ">Web-Development Services</h2>
                        </div>
                      <div class="col-xl-2 col-lg-2 col-md-1 "></div>
                  </div>
                  ...
                  <div class="row">
                        <hr class="my-3 mx-auto page-hr digital-marketing-hr ">
                  </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-5 col-lg-4 col-md-12 col-sm-12 col-12 pb-5 ">
                        <div class="container-fluid  px-5 ms-2 ps-0">
                            ...
                            <div class="row ps-2">
                                <h2 class="display-4 acute-heading digital-marketing-heading  ">Acute Developers</h2>
                                <span class="fs-6 acute-slogan digital-marketing-slogan ">Building Future of your dream.</span>
                            </div>
                            <div class="row my-3">
                                <span class="fs-6 ps-3   acute-sub-heading  digital-marketing-sub-heading ">
                                    <a href="" class="text-decoration-none"><span class="company ">Acute Developers</span></a> &
                                 is a Digital Company that aims to integrate highly competitive technology to help your business grow. We guarantee exceptional results and ensure that our approach works best for your business. We can help your business reach new heights.
                                </span>
                            </div>
                            ...
                            <div class="row button-row">
                                <div class="button-div">
                                    <a href="">
                                        <button class="acute-button digital-marketing-button btn px-4 py-3 fw-bold"><span class=" acute-button-text">LEARN MORE</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="acute-button-icon bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                    ...
                    <div class="container-fluid acute-image-div ms-2 ">
                        <div class="ms-5">
                        <img src="../images/developer-image-new.png" class="w-100 p-5" alt="">
                        </div>
                    </div>
                    </div>
                    </div>
        ...
        <div class="container test-cont pb-5">
                    <div class="card">
                        <div class="content">
                            <img src="../images/web-development.png" class="w-75" alt="">
                            <h3>Web Development</h3>
                            <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                            <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                            <a class="Learn-more" href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Learn More</a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="content">
                            <img src="../images/mobile-development-2.png" class="w-75" alt="">
                    ...
                    <div class="card">
                        <div class="content">
                            <img src="../images/full-stack-2.png" class="w-75" alt="">
        ...
        <section class="acute-designer-section">
                ...
                <div class="container-fluid ">
                  <div class="row margin-md"></div>
                    <div class="row">
                      <div class=" col-xl-2 col-lg-2 col-md-1 "></div>
                        <div class="col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12">
                            <h2 class="display-5  what digital-marketing-title  ">Graphic Design Services</h2>
                        </div>
                      <div class="col-xl-2 col-lg-2 col-md-1 "></div>
                  </div>
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-8 col-md-12 col-sm-12 col-12 ">
                                <div class="container-fluid ">
                                    <img src="../images/designer-image2n.png" class="ms-xl-4 ms-lg-4 ms-md-4 ms-0 w-100" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container test-cont pb-5">
                        <div class="card">
                            <div class="content">
                                <img src="../images/web-design.png" class="w-75" alt="">
                        ...
                        <div class="card">
                            <div class="content">
                                <img src="../images/logo-design.png" class="w-75" alt="">
                                <h3>Logo Design</h3>
                                <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                                <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                                <a class="Learn-more" href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Learn More</a>
                        ...
                        <div class="card">
                            <div class="content">
                                <img src="../images/flyer-design.png" class="w-75 " alt="">
                                <h3>Poster Design</h3>
                                <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                                <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                                <a class="Learn-more" href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Learn More</a>
        ...
        <section class="digital-marketing-section">
                ...
                <div class="container-fluid ">
                  <div class="row margin-md"></div>
                    <div class="row">
                      <div class=" col-xl-2 col-lg-2 col-md-1 "></div>
                        <div class="col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12">
                            <h2 class="display-5  what digital-marketing-title  ">Digital Marketing Services</h2>
                        </div>
                      <div class="col-xl-2 col-lg-2 col-md-1 "></div>
                  </div>
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-8 col-md-12 col-sm-12 col-12 ">
                                <div class="container-fluid ">
                                    <img src="../images/marketing-image.png" class=" w-100 ms-xl-5 ms-lg-5 ms-md-5 ms-0  mt-xl-5 mt-lg-5 mt-md-5 mt-0" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container test-cont pb-5">
                        <div class="card">
                            <div class="content">
                                <img src="../images/facebook-splash.png" class="w-75" alt="">
                                <h3>Facebook Market</h3>
                                <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                                <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                                <a href="acute-developer.html" title="Learn More">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mb-1 next-web-icon p-0 m-0 bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
                                        <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
                                    </svg>
                                </a>
                        ...
                        <div class="card">
                            <div class="content">
                                <img src="../images/instagram-my.png" class="w-75" alt="">
                                <h3>Insatgram Market</h3>
                                <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                                <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                                <a href="acute-developer.html" title="Learn More">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mb-1 next-web-icon p-0 m-0 bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                        ...
                        <div class="card">
                            <div class="content">
                                <img src="../images/youtube-splash.png" class="w-75 " alt="">
                                <h3>Youtube Market</h3>
                                <p>Get Beautiful and fully responsive Website for your business. sampletest is written her to take some space.</p>
                                <a href="//api.whatsapp.com/send?phone=923114145522&text=Hi Acute Developer!   %0D%0AI want to have your *Mobile App Development*  services. %0D%0AIt will be very nice to have words with you." target="blanck" >Book Now</a>
                                <a class="Learn-more" href="index.php #3rd" target="blanck" >Learn More</a>
