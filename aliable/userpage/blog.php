...
<body class="">
  ...
  <header class="container-fluid header py-5">
      ...
      <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="container">
          <div class="row">
          <h2 class="header-heading display-3 fw-bold">Blogs</h2>
          </div>
        </div>
        </div>
      </div>
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12 ">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-0">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="container-fluid shadow mb-5" >
                                        <div class="row p-0">
                                            <div class="col-12 p-0">
                                                <img src="../images/blog1.webp" class="w-100 news-img" alt="">
                                            </div>
                                            <div class="col-12 date-dutton-div">
                                                <button class="date-button btn py-2 px-4  fs-4 ">
                                                    <span class ="date-date ">15 Jan</span>  
                                                </button>
                                            </div>
                                            <div class="col-12 mt-5 px-5">
                                                <h5 class="blog-heading ">Google inks pact for new 35-storey office</h5>
                                            </div>
                                            <div class="col-12 px-5 mt-2 mb-4">
                                                <span class="fs-6 blog-text">
                                            ...
                                            <div class="col-12 px-5 mt-3 mb-4 category-div">
                                            ...
                                            <span class="category-2" >Lifestyle</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="container-fluid shadow mb-5">
                                        <div class="row p-0">
                                            <div class="col-12 p-0">
                                                <img src="../images/blog2.webp" class="w-100 news-img" alt="">
                                            </div>
                                            <div class="col-12 date-dutton-div">
                                                <button class="date-button btn py-2 px-4  fs-4 ">
                                                    <span class ="date-date ">15 Jan</span>  
                                    ...
                                    <div class="container-fluid shadow mb-5">
                                        <div class="row p-0">
                                            <div class="col-12 p-0">
                                                <img src="../images/blog3.webp" class="w-100 news-img" alt="">
                                            </div>
                                            <div class="col-12 date-dutton-div">
                                                <button class="date-button btn py-2 px-4  fs-4 ">
                                                    <span class ="date-date ">15 Jan</span>  
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 p-0 px-4 ">
                            <div class="container-fluid p-0 ms-xl-5 ms-lg-5 ms-0 ">
                                <div class="row ">

                                    <div class="col-12 p-0">
                                        <div class="container-fluid category-list-div ">
                                            <div class="row p-2">

                                                <div class="col-12 px-xl-4 px-lg-4 px-5 mt-2 "> <span class="category-heading"> Category </span> </div>

                                                <hr class="category-hr mx-auto mt-2">

                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Resturants Foods </span> </div>

                                                <hr class="category-hr mx-auto mt-2">

                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Travel News </span> </div>

                                                <hr class="category-hr mx-auto mt-2">
                                                
                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Modren Technology </span> </div>

                                                <hr class="category-hr mx-auto mt-2">
                                                
                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Product </span> </div>

                                                <hr class="category-hr mx-auto mt-2">
                                                
                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Inspiration </span> </div>

                                                <hr class="category-hr mx-auto mt-2">

                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5"> <span class="category-options"> Health Care </span> </div>

                                                <hr class="category-hr mx-auto mt-2">

                                                <div class="col-12 cateogy-col px-xl-4 px-lg-4 px-5 mb-4"> <span class="category-options">Most Famous</span> </div>
                                    ...
                                    <div class="margin-xsm col-12"></div>
                                    ...
                                    <div class="col-12 p-0">
                                        <div class="container-fluid category-list-div ">
                                            <div class="row p-2">
                                                ...
                                                <div class="col-12 px-xl-4 px-lg-4 px-5 mt-2 "> <span class="category-heading"> Famous Posts</span> </div>
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container ms-2 ">
                                                        <div class="row p-0 ">
                                                            <div class="col-3 p-0">
                                                                <a href="">
                                                                    <img src="../images/post1.webp" class="blog-img w-100 h-100" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-9 ">
                                                                    ...
                                                                    <div class="row p-0">
                                                                        <div class="col-12">
                                                                            <a href="#" class="text-decoration-none">
                                                                                <span class="ms-2 fs-6 post-heading">From life was you fish...</span>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-12 post-date-div ">
                                                                            <span class="ms-2 fs-6 post-date ">January 12, 2019</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container ms-2 ">
                                                        <div class="row p-0 ">
                                                            <div class="col-3 p-0">
                                                                <a href="">
                                                                    <img src="../images/post2.webp" class="blog-img w-100 h-100" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-9 ">
                                                                <div class="container-fluid p-0 mt-2">
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container ms-2 ">
                                                        <div class="row p-0 ">
                                                            <div class="col-3 p-0">
                                                                <a href="">
                                                                    <img src="../images/post3.webp" class="blog-img w-100 h-100" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-9 ">
                                                                <div class="container-fluid p-0 mt-2">
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container ms-2 ">
                                                        <div class="row p-0 ">
                                                            <div class="col-3 p-0">
                                                                <a href="">
                                                                    <img src="../images/post4.webp" class="blog-img w-100 h-100" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-9 ">
                                                                <div class="container-fluid p-0 mt-2">
                                    ...
                                    <div class="col-12 p-0">
                                        <div class="container-fluid category-list-div ">
                                            <div class="row p-2">
                                                ...
                                                <div class="col-12 px-xl-4 px-lg-4 px-5 mt-2"> <span class="category-heading">Instagram Feeds</span> </div>
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container  ">
                                                        <div class="row p-0 ">
                                                            <div class="col-4 p-2">
                                                                <a href="https://www.instagram.com/p/CfhRUNXl8De/ " target="self">
                                                                    <img src="../images/post1.webp" class="blog-img w-100 h-100" alt="">
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="col-12 p-0">
                                        <div class="container-fluid category-list-div ">
                                            <div class="row p-2">
                                                ...
                                                <div class="col-12 px-xl-4 px-lg-4 px-5 mt-2 "> <span class="category-heading">News Letter</span> </div>
                                                ...
                                                <div class="col-12  my-2"> 
                                                    <div class="container px-3 ">
                                                        <div class="row p-0 ">
                                                            <div class="col-12 p-0">
                                                                <form action="">
                                                                    <input type="email" name="" id="" placeholder="Enter email" class=" form-control subscribe-input-field" required>
                                                                
                                                            </div>
                                                            <div class="col-12 p-0 mt-4">
                                                                
                                                                    <button type="submit" class="btn subscribe-button px-5 w-100 py-3">SUBSCRIBE</button>
                                                                </form>
                                                            </div>
                                    ...
                                    <div class="col-12 margin-xsm d-xl-none "></div>
  ...
  <div class="container-fluid">
    <div class="row margin-md d-xl-block d-lg-block d-sm-none d-none">
    </div>
  </div>
